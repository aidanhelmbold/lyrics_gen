...
def train_poetry(artist):
    ...
    if sentences:
        ...
        rnn.save(artist+'RRNN_D50_M50_epochs2000_relu.npz')
    else:
        print('couldnt train')
        sys.exit()

def generate_poetry(artist):
    sentences, word2idx = get_text_file('text/'+artist+'.txt')
...
if __name__ == '__main__':
    ...
    if args['train']:    
        train_poetry(args['artist'])
    generate_poetry(args['artist'])
